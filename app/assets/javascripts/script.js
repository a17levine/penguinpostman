$(document).ready(function() {  
    $('#first').hide().css("visibility", "visible").delay().fadeIn("slow");
    $('#second').hide().css("visibility", "visible").delay().fadeIn("slow");
    $('#third').hide().css("visibility", "visible").delay().fadeIn("slow");
